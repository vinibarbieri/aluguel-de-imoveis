...
with app.app_context():
    ...
    # Função para criar reservas passadas com avaliações
    def create_reservation_with_review(property, renter, days_ago, duration, rating, comment):
        ...
        db.session.flush()  # importante para gerar ID antes de criar a review
    ...
    create_reservation_with_review(imovel1, locatario1, 60, 5, 5, "Maravilhosa estadia!")
    create_reservation_with_review(imovel2, locatario2, 45, 4, 4, "Boa localização e limpo.")
    create_reservation_with_review(imovel3, locatario1, 30, 3, 3, "Lugar aconchegante, mas difícil acesso.")
    create_reservation_with_review(imovel4, locatario2, 15, 2, 5, "Perfeito para viagens rápidas!")

    db.session.commit()

    print("✅ Banco populado com sucesso com dados reais de locadores, locatários, reservas e avaliações!")
